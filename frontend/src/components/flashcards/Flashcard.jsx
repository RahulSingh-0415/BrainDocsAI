  ...
  return (
    <div className=" relative w-full h-72" style={{ perspective: '1000px' }}>
      ...
      >
        ...
        <div
          className=" absolute inset-0 w-full h-full bg-linear-to-br from-purple-500 to-purple-500 border-2 border-purple-400/60 rounded-2xl shadow-xl shadow-purple-500/30 flex flex-col justify-between"
          style={{
            backfaceVisibility: 'hidden',
            WebkitBackfaceVisibility: 'hidden',
