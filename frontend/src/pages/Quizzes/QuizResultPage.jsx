  ...
  return (
    <div className="max-w-5xl mx-auto px-4 pb-20">
      ...
      <Link
        ...
        className="inline-flex items-center gap-2 text-sm text-gray-600 hover:text-purple-500 mb-6"
      >
        <ArrowLeft size={18} />
        Back to Document
      </Link>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-10 text-center">
        ...
        <div className="mt-6 flex justify-center gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-purple-100 text-purple-600 text-sm">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 text-xs font-medium">
                          ...
                          {optIsCorrect && (
                            <span className="px-2 py-0.5 rounded-full bg-purple-100 text-purple-600">
                              Correct Answer
                            </span>
                          )}
                        </div>
