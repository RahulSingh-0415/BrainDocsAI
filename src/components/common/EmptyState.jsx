  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-6 text-center bg-linear-to-br from-slate-50/50 to-white border-2 border-dashed border-slate-200 rounded-3xl">
      ...
      {buttonText && onActionClick && (
        <button onClick={onActionClick} className="group relative inline-flex items-center gap-2 px-6 h-11 bg-linear-to-r from-purple-500 to-purple-500 rounded-xl text-white hover:from-purple-600 hover:to-purple-600 font-semibold text-sm transition-all duration-200 shadow-lg shadow-purple-500/25 active:scale-95 focus:outline-none focus:ring-4 focus:ring-purple-500/20 overflow-hidden">
